(function() {
  ...
  module.exports = (function() {
    ...
    function exports(config) {
      ...
      this.endpoint = 'statuses/sample';
      if (this.config.endpoint != null) this.endpoint = this.config.endpoint;
      this.search = void 0;
      if (this.config.search != null) this.search = this.config.search;
      this.filters = [];
    ...
    exports.prototype.start = function() {
      var _this = this;
      return this.twitter.stream(this.endpoint, this.search, function(s) {
        var process;
